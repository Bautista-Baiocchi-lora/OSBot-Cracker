    ...
    public HookCollection() {
       ...
       iterateMapTwo("org.osbot.core.inject.hook.FieldHook");
        for (Map.Entry<String, FieldHook> fieldHookMap : fieldHookMap.entrySet()) {
            Logger.log("MappedName: "+fieldHookMap.getKey() + " || OriginalName: "+fieldHookMap.getValue().originalName + " || desc: "+fieldHookMap.getValue().originalDesc); //comment this out of you like!
        }
    }
